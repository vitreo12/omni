...
extern "C" {
    ...
    //Print
    typedef void   omni_print_str_val_func_t(const char* format_string, size_t value);
    ...
    //Print
    extern void Omni_InitPrint(omni_print_str_val_func_t* print_str_val_func, omni_print_str_func_t* print_str_func, omni_print_float_func_t* print_float_func, omni_print_int_func_t* print_int_func);
    extern omni_print_str_val_func_t* get_omni_print_str_val_func();
