...
{
    printf("Calling Omni_Init_Alloc\n");
...
{
    printf("Calling omni_alloc_C with size: %d\n", inSize);
    return omni_alloc_func(inSize);
}

void* omni_alloc0_C(size_t inSize)
{
    printf("Calling omni_alloc0_C with size: %d\n", inSize);
...
{
    printf("Calling omni_realloc_C with size: %d\n", inSize);
    return omni_realloc_func(inPtr, inSize);
}

void omni_free_C(void* inPtr)
{
    printf("Calling omni_free_C\n");
