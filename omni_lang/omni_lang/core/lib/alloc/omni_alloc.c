...
{
    omni_print_StrVal_func_t* omni_print_StrVal_func = get_omni_print_StrVal_func();
    if(omni_print_StrVal_func)
        omni_print_StrVal_func("Calling omni_alloc_C with size: ", in_size);
...
void* omni_realloc_C(void *in_ptr, size_t in_size)
{
    omni_print_StrVal_func_t* omni_print_StrVal_func = get_omni_print_StrVal_func();
    if(omni_print_StrVal_func)
        omni_print_StrVal_func("Calling omni_realloc_C with size: ", in_size);
...
void omni_free_C(void* in_ptr)
{
    omni_print_StrVal_func_t* omni_print_StrVal_func = get_omni_print_StrVal_func();
    if(omni_print_StrVal_func)
        omni_print_StrVal_func("Calling omni_free_C: ", 0);
