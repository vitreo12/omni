...
omni_print_dbg_func_t* omni_print_dbg_func;
...
{
    omni_print_dbg_func = print_dbg_func;
    omni_print_str_func   = print_str_func;
    omni_print_float_func = print_float_func;
    omni_print_int_func   = print_int_func;
}

omni_print_dbg_func_t* get_omni_print_dbg_func()
{
    return omni_print_dbg_func;
}

void omni_print_dbg_C(const char* format_string, size_t value)
{
    omni_print_dbg_func(format_string, value);
}
